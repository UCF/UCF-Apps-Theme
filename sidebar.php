...
<?php if(!function_exists('dynamic_sidebar') or !dynamic_sidebar('Sidebar')):?>
	...
	<?=do_shortcode('[search_form post_type_name="resourcelink" taxonomy="pg_sections" taxonomy_term="'.$taxonomy_term.'" column_width="span3" column_count="1" show_empty_sections=true default_search_text="Find a Resource"]')?>
